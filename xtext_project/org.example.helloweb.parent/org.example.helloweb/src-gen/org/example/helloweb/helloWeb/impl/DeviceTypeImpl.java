...
public class DeviceTypeImpl extends MinimalEObjectImpl.Container implements DeviceType
{
  ...
  /**
   * The cached value of the '{@link #getBatchRatePolicy() <em>Batch Rate Policy</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected TimeUnit batchRatePolicy;
  ...
  /**
   * The cached value of the '{@link #getHeartBeatPolicy() <em>Heart Beat Policy</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected TimeUnit heartBeatPolicy;
   ...
   */
  @Override
  public TimeUnit getBatchRatePolicy()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetBatchRatePolicy(TimeUnit newBatchRatePolicy, NotificationChain msgs)
  {
    TimeUnit oldBatchRatePolicy = batchRatePolicy;
    batchRatePolicy = newBatchRatePolicy;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY, oldBatchRatePolicy, newBatchRatePolicy);
   ...
   */
  @Override
  public void setBatchRatePolicy(TimeUnit newBatchRatePolicy)
  {
    if (newBatchRatePolicy != batchRatePolicy)
    {
      NotificationChain msgs = null;
      if (batchRatePolicy != null)
        msgs = ((InternalEObject)batchRatePolicy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY, null, msgs);
      if (newBatchRatePolicy != null)
        msgs = ((InternalEObject)newBatchRatePolicy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY, null, msgs);
      msgs = basicSetBatchRatePolicy(newBatchRatePolicy, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY, newBatchRatePolicy, newBatchRatePolicy));
  }
   ...
   */
  @Override
  public TimeUnit getHeartBeatPolicy()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetHeartBeatPolicy(TimeUnit newHeartBeatPolicy, NotificationChain msgs)
  {
    TimeUnit oldHeartBeatPolicy = heartBeatPolicy;
    heartBeatPolicy = newHeartBeatPolicy;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY, oldHeartBeatPolicy, newHeartBeatPolicy);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   */
  @Override
  public void setHeartBeatPolicy(TimeUnit newHeartBeatPolicy)
  {
    if (newHeartBeatPolicy != heartBeatPolicy)
    {
      NotificationChain msgs = null;
      if (heartBeatPolicy != null)
        msgs = ((InternalEObject)heartBeatPolicy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY, null, msgs);
      if (newHeartBeatPolicy != null)
        msgs = ((InternalEObject)newHeartBeatPolicy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY, null, msgs);
      msgs = basicSetHeartBeatPolicy(newHeartBeatPolicy, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY, newHeartBeatPolicy, newHeartBeatPolicy));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY:
        return basicSetBatchRatePolicy(null, msgs);
      case HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY:
        return basicSetHeartBeatPolicy(null, msgs);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case HelloWebPackage.DEVICE_TYPE__SENSOR_INSTANTIATIONS:
        ...
        return;
      case HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY:
        setBatchRatePolicy((TimeUnit)newValue);
        return;
      case HelloWebPackage.DEVICE_TYPE__BATCH_SIZE_POLICY:
        setBatchSizePolicy((Integer)newValue);
        return;
      case HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY:
        setHeartBeatPolicy((TimeUnit)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case HelloWebPackage.DEVICE_TYPE__SENSOR_INSTANTIATIONS:
        ...
        return;
      case HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY:
        setBatchRatePolicy((TimeUnit)null);
        return;
      case HelloWebPackage.DEVICE_TYPE__BATCH_SIZE_POLICY:
        setBatchSizePolicy(BATCH_SIZE_POLICY_EDEFAULT);
        return;
      case HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY:
        setHeartBeatPolicy((TimeUnit)null);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case HelloWebPackage.DEVICE_TYPE__BATCH_RATE_POLICY:
        return batchRatePolicy != null;
      case HelloWebPackage.DEVICE_TYPE__BATCH_SIZE_POLICY:
        return batchSizePolicy != BATCH_SIZE_POLICY_EDEFAULT;
      case HelloWebPackage.DEVICE_TYPE__HEART_BEAT_POLICY:
        return heartBeatPolicy != null;
    }
