...
public class HelloWebParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, HelloWebGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTimeUnitAccess().getUnitAlternatives_1_0(), "rule__TimeUnit__UnitAlternatives_1_0");
			...
			builder.put(grammarAccess.getTimeUnitAccess().getValueAssignment_0(), "rule__TimeUnit__ValueAssignment_0");
			builder.put(grammarAccess.getTimeUnitAccess().getUnitAssignment_1(), "rule__TimeUnit__UnitAssignment_1");
