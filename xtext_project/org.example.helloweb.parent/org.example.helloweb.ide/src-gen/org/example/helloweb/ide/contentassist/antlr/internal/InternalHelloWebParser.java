...
public class InternalHelloWebParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'AND'", "'OR'", "'NOT'", "'s'", "'m'", "'h'", "'d'", "'>'", "'<'", "'>='", "'<='", "'='", "'!='", "'sensor'", "'{'", "'units:'", "'reader:'", "'pins:'", "'out:'", "'}'", "','", "'deviceType'", "'batchRatePolicy:'", "'batchSizePolicy:'", "'heartBeatPolicy:'", "'samplingRate:'", "'('", "')'", "'.'"
    };
    ...
    public final void rule__ComparisonValue__Alternatives() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA5_0==RULE_ID) ) {
                ...
                if ( (LA5_2==EOF||(LA5_2>=18 && LA5_2<=23)||LA5_2==38) ) {
                    alt5=3;
                }
                else if ( (LA5_2==39) ) {
                    alt5=2;
    ...
    // $ANTLR start "rule__TimeUnit__UnitAlternatives_1_0"
    // InternalHelloWeb.g:548:1: rule__TimeUnit__UnitAlternatives_1_0 : ( ( 's' ) | ( 'm' ) | ( 'h' ) | ( 'd' ) );
    public final void rule__TimeUnit__UnitAlternatives_1_0() throws RecognitionException {
    ...
    // $ANTLR end "rule__TimeUnit__UnitAlternatives_1_0"
    ...
    // InternalHelloWeb.g:2582:1: rule__TimeUnit__Group__0__Impl : ( ( rule__TimeUnit__ValueAssignment_0 ) ) ;
    public final void rule__TimeUnit__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalHelloWeb.g:2586:1: ( ( ( rule__TimeUnit__ValueAssignment_0 ) ) )
            // InternalHelloWeb.g:2587:1: ( ( rule__TimeUnit__ValueAssignment_0 ) )
            {
            // InternalHelloWeb.g:2587:1: ( ( rule__TimeUnit__ValueAssignment_0 ) )
            // InternalHelloWeb.g:2588:2: ( rule__TimeUnit__ValueAssignment_0 )
            {
             before(grammarAccess.getTimeUnitAccess().getValueAssignment_0()); 
            // InternalHelloWeb.g:2589:2: ( rule__TimeUnit__ValueAssignment_0 )
            // InternalHelloWeb.g:2589:3: rule__TimeUnit__ValueAssignment_0
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalHelloWeb.g:2608:1: rule__TimeUnit__Group__1__Impl : ( ( rule__TimeUnit__UnitAssignment_1 ) ) ;
    public final void rule__TimeUnit__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalHelloWeb.g:2612:1: ( ( ( rule__TimeUnit__UnitAssignment_1 ) ) )
            // InternalHelloWeb.g:2613:1: ( ( rule__TimeUnit__UnitAssignment_1 ) )
            {
            // InternalHelloWeb.g:2613:1: ( ( rule__TimeUnit__UnitAssignment_1 ) )
            // InternalHelloWeb.g:2614:2: ( rule__TimeUnit__UnitAssignment_1 )
            {
             before(grammarAccess.getTimeUnitAccess().getUnitAssignment_1()); 
            // InternalHelloWeb.g:2615:2: ( rule__TimeUnit__UnitAssignment_1 )
            // InternalHelloWeb.g:2615:3: rule__TimeUnit__UnitAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // $ANTLR start "rule__TimeUnit__ValueAssignment_0"
    // InternalHelloWeb.g:3238:1: rule__TimeUnit__ValueAssignment_0 : ( RULE_INT ) ;
    public final void rule__TimeUnit__ValueAssignment_0() throws RecognitionException {
    ...
    // $ANTLR end "rule__TimeUnit__ValueAssignment_0"


    // $ANTLR start "rule__TimeUnit__UnitAssignment_1"
    // InternalHelloWeb.g:3253:1: rule__TimeUnit__UnitAssignment_1 : ( ( rule__TimeUnit__UnitAlternatives_1_0 ) ) ;
    public final void rule__TimeUnit__UnitAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalHelloWeb.g:3257:1: ( ( ( rule__TimeUnit__UnitAlternatives_1_0 ) ) )
            // InternalHelloWeb.g:3258:2: ( ( rule__TimeUnit__UnitAlternatives_1_0 ) )
            {
            // InternalHelloWeb.g:3258:2: ( ( rule__TimeUnit__UnitAlternatives_1_0 ) )
            // InternalHelloWeb.g:3259:3: ( rule__TimeUnit__UnitAlternatives_1_0 )
            {
             before(grammarAccess.getTimeUnitAccess().getUnitAlternatives_1_0()); 
            // InternalHelloWeb.g:3260:3: ( rule__TimeUnit__UnitAlternatives_1_0 )
            // InternalHelloWeb.g:3260:4: rule__TimeUnit__UnitAlternatives_1_0
            {
            pushFollow(FOLLOW_2);
    ...
    // $ANTLR end "rule__TimeUnit__UnitAssignment_1"


    // $ANTLR start "rule__Decimal__LeftAssignment_0"
    // InternalHelloWeb.g:3268:1: rule__Decimal__LeftAssignment_0 : ( RULE_INT ) ;
    public final void rule__Decimal__LeftAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalHelloWeb.g:3272:1: ( ( RULE_INT ) )
            // InternalHelloWeb.g:3273:2: ( RULE_INT )
            {
            // InternalHelloWeb.g:3273:2: ( RULE_INT )
            // InternalHelloWeb.g:3274:3: RULE_INT
            {
    ...
    // InternalHelloWeb.g:3283:1: rule__Decimal__RightAssignment_2 : ( RULE_INT ) ;
    public final void rule__Decimal__RightAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalHelloWeb.g:3287:1: ( ( RULE_INT ) )
            // InternalHelloWeb.g:3288:2: ( RULE_INT )
            {
            // InternalHelloWeb.g:3288:2: ( RULE_INT )
            // InternalHelloWeb.g:3289:3: RULE_INT
            {
    ...
    public static final BitSet FOLLOW_12 = new BitSet(new long[]{0x0000000E40000010L});
