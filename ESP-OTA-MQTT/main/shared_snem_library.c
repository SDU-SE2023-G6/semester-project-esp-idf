// This file is a dummy file that will be overwritten by the code generator.
// The purpose is to provide a dummy implementation that one can implement against.
